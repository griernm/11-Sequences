...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 2
    actual = count_positive_sines([2, 10, 8])
    print()
    ...
    # Test 12:
    expected = 2
    actual = count_positive_sines([4, 7, 12, 89])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 9:
    expected = -96
    actual = sum_first_n([4, -100, 200, 5], 2)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
